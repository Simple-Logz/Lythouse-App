...
export type WorkspaceMember={id:string;workspace_id:string;user_id:string;role:'owner'|'admin'|'member'|'viewer';created_at:string};
export type WorkspacePlan={id:string;workspace_id:string;plan_id:PlanId;status:'active'|'cancelled'|'trialing';trial_ends_at:string|null;current_period_end:string|null;created_at:string;updated_at:string};
...
free:{id:'free',name:'Free',price:0,color:'bg-gray-100 text-gray-700',badge:'bg-gray-100 text-gray-600 border-gray-200'},
