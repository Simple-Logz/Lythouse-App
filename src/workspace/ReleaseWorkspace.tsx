...
function toBiz(sev:string){
  ...
  return{label:'Informational',color:'text-gray-600',bg:'bg-gray-50',border:'border-[#a1a1aa]',dot:'bg-gray-400'};
}
  ...
  return(
    <div className="flex flex-row lg:h-full lg:[min-height:calc(100vh-130px)]">
      ...
      <div className="w-[68px] lg:w-48 shrink-0 border-r border-gray-100 bg-gray-50/60 flex flex-col py-3 lg:py-4 px-1.5 lg:px-2 gap-1.5 lg:gap-1">
        ...
        <div className="mt-auto pt-3 lg:pt-4 border-t border-[#a1a1aa]">
      ...
      <div className="flex-1 min-w-0 lg:overflow-y-auto">
        ...
        <div className="px-3 sm:px-6 py-4 sm:py-5">
          ...
          {stage==='changes'&&(()=>{
            ...
            const toneBg={red:'bg-red-50 border-red-200',amber:'bg-amber-50 border-amber-200',green:'bg-green-50 border-green-200',gray:'bg-gray-50 border-[#a1a1aa]'}[verdict.tone];
            ...
            const dBg={red:'bg-red-50 border-red-200',amber:'bg-amber-50 border-amber-200',green:'bg-green-50 border-green-200',gray:'bg-gray-50 border-[#a1a1aa]'}[decision.tone];
            const checklist=[
              ...
              {false&&(
                <>
                  ...
                  <div className={`card border ${dBg}`}>
                    ...
                    {attention.length>0&&(
                      <div className="mt-4 rounded-xl bg-white/70 border border-[#a1a1aa] px-4 py-3">
                    ...
                    <div className="mt-4 pt-4 border-t border-[#a1a1aa]/70 flex flex-wrap items-center gap-2">
                        ...
                        {isExp&&(
                          <div className="bg-white border-t border-gray-100 px-4 py-4 space-y-3">
                            ...
                            <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-100">
                              ...
                              <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#a1a1aa] bg-gray-50 text-gray-700 text-xs font-medium hover:bg-gray-100"><Ticket size={11}/>Create Ticket</button>
                              <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#a1a1aa] bg-gray-50 text-gray-700 text-xs font-medium hover:bg-gray-100"><GitPullRequest size={11}/>Create PR</button>
                              <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#a1a1aa] bg-gray-50 text-gray-700 text-xs font-medium hover:bg-gray-100"><MessageSquare size={11}/>Notify Slack</button>
                            </div>
                          </div>
                        )}
                      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="card border-brand-200 bg-brand-50/50">
                ...
                <div className="grid gap-2 sm:grid-cols-3 mt-3">
                  {[
                    ...
                    <div key={x.t} className="rounded-lg border border-[#a1a1aa] bg-white px-3 py-2">
              ...
              {approvals.length===0?(
                ...
                approvals.slice(0,3).map(release=>{
                  ...
                  return(
                    <div key={release.id} className={`card border-2 ${allApproved?'border-green-300 bg-green-50':'border-[#a1a1aa]'}`}>
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          return(
                            <div key={role.id} className={`flex items-center justify-between gap-3 rounded-xl border px-4 py-3 ${approved?'border-green-200 bg-green-50':'border-[#a1a1aa] bg-white'}`}>
                              <div>
          ...
          {stage==='deployment'&&(
            <div className="space-y-4">
              ...
              <div className={`card border-2 text-center py-12 ${deployGated?'border-red-200':'border-[#a1a1aa]'}`}>
                {deployGated?(
                  <>
      ...
      {!sidebarOpen&&stage!=='changes'&&(
        <button onClick={()=>setSidebarOpen(true)} className="fixed right-4 top-1/2 -translate-y-1/2 z-30 flex flex-col items-center gap-1 bg-white border border-[#a1a1aa] rounded-xl px-2 py-3 shadow-lg hover:bg-gray-50 transition-colors">
