    ...
    <div className="space-y-5">
      ...
      <div className="card">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:border-l sm:border-[#71717a] sm:pl-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {d.sim.map((s, i, arr) => (
            <div key={i} className="flex items-center gap-2">
              <span className={`inline-flex items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs font-medium ${s.s === 'fail' ? 'border-[#f5a3a3] bg-[#fde3e3] text-[#d61f1f]' : s.s === 'warn' ? 'border-[#f9c777] bg-[#fff0d9] text-[#e07600]' : 'border-[#71717a] bg-white text-navy-700'}`}>{SIM[s.s]}{s.k}</span>
