...
export function ProjectIntegrationsPage({ projectId, workspaceId, project }) {
  ...
  return (
    <div className="mx-auto max-w-5xl">
        ...
        <div className="relative shrink-0">
          ...
          {menuOpen && (
            <>
              ...
              <div className="absolute right-0 top-full z-30 mt-2 max-h-[62vh] w-64 overflow-y-auto rounded-xl border border-[#71717a] bg-white p-1.5 shadow-lift">
      ...
      {/* connected list */}
      {connected.length === 0 ? (
        <div className="rounded-2xl border-2 border-dashed border-[#71717a] py-14 text-center">
