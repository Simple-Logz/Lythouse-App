    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          {label:'Open',value:open.length,color:'text-navy-900',bg:'bg-gray-50',border:'border-[#d4d4d8]',f:()=>{setSevFilter('all');setStatusFilter('open');}},
            ...
            return(
              <div key={cat}>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="chip bg-gray-100 text-gray-500 border border-[#d4d4d8]">{items.length}</span>
                ...
                <div className="space-y-1.5">
                  {items.map(f=>{
                    ...
                    return(
                      <div key={f.id} className={`rounded-xl border overflow-hidden transition-all ${f.status==='resolved'?'opacity-60 border-[#d4d4d8]':f.severity==='critical'?'border-red-200':f.severity==='high'?'border-amber-200':'border-[#d4d4d8]'}`}>
                        ...
                        {isOpen&&(
                          <div className="border-t border-gray-100 bg-white px-4 py-4 space-y-4">
                            ...
                            {/* File location */}
                            {f.file_path&&(
                              <div className="flex items-center gap-2 rounded-lg bg-gray-50 border border-[#d4d4d8] px-3 py-2">
