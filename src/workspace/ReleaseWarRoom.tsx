    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          {label:'Risk Score',value:`${latest?.risk_score??'—'}/100`,color:(latest?.risk_score??0)>70?'text-red-600':(latest?.risk_score??0)>40?'text-amber-600':'text-green-600',bg:'bg-gray-50',border:'border-[#d4d4d8]'},
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="card">
          ...
          {aiRec?(
            ...
            <div className="flex items-center justify-center h-24 text-sm text-gray-400 bg-gray-50 rounded-xl border border-[#d4d4d8]">
        ...
        <div className="card">
          ...
          <div className="space-y-2">
            {open.slice(0,8).map(f=>(
              <div key={f.id} className={`flex items-start gap-3 rounded-lg border px-3 py-2.5 ${f.severity==='critical'?'border-red-200 bg-red-50':f.severity==='high'?'border-amber-200 bg-amber-50':'border-[#d4d4d8] bg-white'}`}>
