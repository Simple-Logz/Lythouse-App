...
export function TeamPage(){
              ...
              {grpMembers.map(m=>{
                ...
                return(
                  <div key={m.user_id} className="flex items-center gap-3 py-3">
                    ...
                    <span className="chip bg-gray-100 text-gray-600 border border-[#18181b] capitalize text-xs">{m.role}</span>
  ...
  return(
    <div>
      ...
      {/* Tabs */}
      <div className="mb-5 flex gap-1 border-b border-[#18181b]">
                  ...
                  <div className="border-t border-gray-100 bg-gray-50/50 px-4 py-3">
                    {gms.length===0
                      ...
                      :<div className="space-y-2 mb-3">
                        {gms.map(gm=>(
                          <div key={gm.id} className="flex items-center justify-between rounded-lg bg-white border border-[#18181b] px-3 py-2">
                            <div className="flex items-center gap-2">
          ...
          <div className="w-full max-w-md animate-scale-in rounded-xl bg-white p-6 shadow-xl" onClick={e=>e.stopPropagation()}>
            ...
            {lastLink?(
              <div className="mb-2">
                ...
                <div className="flex items-center gap-2">
                  <code className="flex-1 truncate rounded-lg border border-[#18181b] bg-gray-50 px-3 py-2 text-xs text-navy-800">{lastLink}</code>
            ...
            <div className="space-y-2 mb-5">
              {ASSIGNABLE_ROLES.map(r=>(
                <label key={r} className={`flex items-start gap-3 rounded-lg border p-3 cursor-pointer transition-colors ${inviteRole===r?'border-brand-300 bg-brand-50':'border-[#18181b] hover:bg-gray-50'}`}>
