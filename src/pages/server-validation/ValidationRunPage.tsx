...
function VerdictBadge({ verdict }: { verdict: Verdict | null }) {
  if (!verdict) return <span className="chip bg-gray-100 text-gray-500 border border-gray-200">No verdict</span>;
  const m: Record<Verdict, { label: string; cls: string; icon: typeof ShieldCheck }> = {
    ...
    inconclusive: { label: 'Inconclusive', cls: 'bg-gray-100 text-gray-500 border border-gray-200', icon: ShieldAlert },
  };
  const v = m[verdict];
  const Icon = v.icon;
          ...
          {change && (
            <div className="card">
              ...
              <div className="flex items-center gap-2 mb-2">
                <span className="chip bg-gray-100 text-gray-600 border border-gray-200 capitalize">{change.change_type}</span>
                ...
                {evidence.map(ev => (
                  <div key={ev.id} className="flex items-start justify-between rounded-lg border border-gray-100 p-3">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <span className="chip bg-gray-100 text-gray-600 border border-gray-200">{ev.evidence_type}</span>
          ...
          {rollback && (
            <div className="card">
              ...
              <div className="flex items-center gap-2 mb-3">
                <span className="chip bg-gray-100 text-gray-600 border border-gray-200 capitalize">{rollback.rollback_method}</span>
