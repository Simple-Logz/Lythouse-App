...
function Node({ icon: Icon, title, sub, tone = 'default' }) {
  const tones = {
    default: 'border-[#d4d4d8] bg-white',
  ...
  return (
    <div>
      ...
      <div className="mx-auto mb-10 max-w-3xl">
        ...
        <div className="mx-auto w-full max-w-2xl rounded-2xl border border-[#d4d4d8] bg-white p-4 shadow-soft">
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-[#d4d4d8] py-14 text-center">
          ...
          {validations.map((v) => {
            ...
            return (
              <Link
                ...
                className="flex items-center justify-between gap-4 rounded-2xl border border-gray-100 bg-white px-5 py-3.5 shadow-sm transition-colors hover:border-[#d4d4d8]"
              >
