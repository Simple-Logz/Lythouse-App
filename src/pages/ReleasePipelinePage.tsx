...
function Node({ icon: Icon, title, sub, tone = 'default' }) {
  const tones = {
    default: 'border-[#a1a1aa] bg-white',
  ...
  return (
    <div>
      ...
      <div className="mx-auto mb-10 max-w-3xl">
        ...
        <div className="mx-auto w-full max-w-2xl rounded-2xl border border-[#a1a1aa] bg-white p-4 shadow-soft">
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-[#a1a1aa] py-14 text-center">
          ...
          {validations.map((v) => {
            ...
            return (
              <Link
                ...
                className="flex items-center justify-between gap-4 rounded-2xl border border-gray-100 bg-white px-5 py-3.5 shadow-sm transition-colors hover:border-[#a1a1aa]"
              >
