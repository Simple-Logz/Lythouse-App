            ...
            <div>
              ...
              <div className="mt-8 flex max-w-md flex-col sm:flex-row items-stretch gap-2">
                <input
                  ...
                  className="flex-1 rounded-full border border-[#d4d4d8] bg-white/80 px-5 py-3 text-sm text-navy-900 placeholder:text-gray-400 shadow-sm outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100" />
        ...
        <section id="how" className="mx-auto max-w-6xl px-5 py-28">
          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Tilt key={f.t} max={6} className="rounded-2xl border border-[#d4d4d8] bg-white/80 backdrop-blur p-6 hover:border-brand-200 [box-shadow:0_1px_2px_rgba(16,24,40,.05),0_10px_20px_-8px_rgba(16,24,40,.10)] hover:[box-shadow:0_10px_20px_rgba(16,24,40,.08),0_30px_48px_-16px_rgba(124,92,230,.28)]">
