...
export function CommandCenter() {
  ...
  const heatColor = (r) => r.readiness == null ? 'bg-gray-100 text-gray-400 border-[#18181b]' : r.status === 'BLOCKED' ? 'bg-[#fde3e3] text-[#d61f1f] border-[#f5a3a3]' : r.readiness >= 80 ? 'bg-[#e3f7ea] text-[#0f9a4c] border-[#9adcb4]' : 'bg-[#fff0d9] text-[#e07600] border-[#f9c777]';
