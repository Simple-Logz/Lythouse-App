...
.ai-x{margin-left:auto;width:28px;height:28px;border-radius:7px;border:0.5px solid var(--lh-border);background:transparent;color:var(--lh-text2);display:grid;place-items:center;cursor:pointer}
...
.ai-msg.a{align-self:flex-start;background:var(--lh-surface2);color:var(--lh-text);border:0.5px solid var(--lh-border);border-bottom-left-radius:4px}
...
.ai-chip{font-size:12px;padding:6px 10px;border-radius:16px;border:0.5px solid var(--lh-border);background:var(--lh-surface2);color:var(--lh-text2);cursor:pointer}
.ai-chip:hover{border-color:var(--lh-accent);color:var(--lh-text)}
.ai-foot{padding:11px;border-top:0.5px solid var(--lh-border);display:flex;gap:8px;align-items:flex-end}
.ai-in{flex:1;background:var(--lh-surface2);border:0.5px solid var(--lh-border);border-radius:11px;padding:9px 12px;font:inherit;font-size:13.5px;color:var(--lh-text);outline:none;resize:none;max-height:96px;line-height:1.45}
