                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {connected
                      ...
                      : <span className="chip text-[10px] bg-gray-100 text-gray-500 border border-[#71717a]">Not connected</span>}
                    {!p.oneClick && <span className="chip text-[10px] bg-gray-100 text-gray-500 border border-[#71717a]">beta</span>}
                  </div>
